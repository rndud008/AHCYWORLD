...
import { changeValue, detailListHandleClose, moveFolder } from '../../../utils/postUtils';
  ...
  return (
    <>
     <Modal show={show} onHide={(e)=>detailListHandleClose(e,setShow,show)}>
            ...
            <Modal.Body>
              <Form onSubmit={(e) => moveFolder(e,dispatch,hompyId,postName,folderId,postId,moveFolderId,navigate)}>
                <Form.Group>
                      ...
                      folderList.map((folderItem) => {
                        return (
                          <Form.Check
                            ...
                            checked={parseInt(folderItem.id) === parseInt(moveFolderId)}
                          />
                        );
                      })}
                  </div>
