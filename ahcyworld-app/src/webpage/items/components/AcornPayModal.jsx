                ...
                <div style={{ padding: "20px", maxWidth: "600px", margin: "auto" }}>
                    ...
                    <div style={{ marginTop: "10px", border: "1px solid #ddd", padding: "10px" }}>
                                ...
                                >
                                    {payitem.item.itemType === "글꼴" ? (
                                        <input
                                            ...
                                            type='text'
                                            style={{
                                                fontFamily: `${payitem.item.sourceName}, cursive`,
                                                fontSize: 50,
                                                width: 100,
                                                height: 100,
                                            }}
                                    ...
                                    <div style={{ width: "100px", textAlign: "right" }}>
                                        {payitem.item.price}{" "}
                                        <img style={{ width: 15, height: 15 }} src={acorn} alt=''></img>
                                    </div>
                                </div>
                            ))}
                        </div>
                        <div style={{ textAlign: "right", marginTop: "10px" }}>
                            ...
                            <hr />
                            <div>
                                잔여 도토리: {userInfo.acorn - totalAcorn}{" "}
                                <img style={{ width: 15, height: 15 }} src={acorn} alt=''></img>
                            </div>
                            <div></div>
                        </div>
                    ...
                    <div style={{ marginTop: "20px", display: "flex", justifyContent: "space-between" }}>
                        <button className='paymodal-close-btn' onClick={onClose}>
                            취소
                        </button>
                        <button className='paymodal-add-btn' onClick={() => alertPayed()}>
                            결제
                        </button>
                    </div>
